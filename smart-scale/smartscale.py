...
ACCESS_KEY = "ist_PLTdL-0bh7Bp3kEaO20LsW7jPvCNKPFE"
METRIC_UNITS = True
WEIGHT_SAMPLES = 500
...
class EventProcessor:
    ...
    def messageWeighFirst(self, weight, unit):
        ...
        msg = []
        msg.append("This is your Products Starting Weight" + str(weight) + " " + unit + "!")
    ...
    def messageWeighLess(self, weight, weightChange, unit):
        ...
        msg = []
	msg.append("You Used " + str(abs(weightChange)) + " " + unit + " since last time (" + str(weight) + " " + unit + ").")
        return msg[randint(0, len(msg)-1)]
    ...
    def messageWeighMore(self, weight, weightChange, unit):
        ...
        weightChange = float("{0:.2f}".format(weightChange))
        msg = []
	msg.append("Your Product ways more than normal, take something off " + str(weightChange) + " " + unit + " since last time (" + str(weight) + " " + unit + ").")
	return msg[randint(0, len(msg)-1)]
    ...
    def messageWeighSame(self, weight, weightChange, unit):
        ...
        weightChange = float("{0:.2f}".format(weightChange))
        msg = []
        msg.append("No Change in Product usage " + str(weight) + " " + unit + " (" + str(weightChange) + " " + unit + " change)")
        return msg[randint(0, len(msg)-1)]
